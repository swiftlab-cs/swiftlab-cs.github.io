  ...
  return (
    <>
      ...
      <div className="container news">
        ...
        <ul>
            <li>
                <b>Feb. 2026: </b> We are <strong>recruiting PhD students</strong> working on efficient machine learning systems in 2026 Fall. Feel free to email us if you are interested!
            </li>
            <li>
